...
const Qd = "/assets/logo-ab481e85.svg";
function oa(e) {
  return ae({
    tag: "svg",
...
const h8 = ({ onClose: e, categories: t, subCategories: n }) => {
  ...
  ri = async () => {
    const e = await fetch("https://rich-tan-barnacle-tam.cyclic.app/oducts");
...
const oT = ({ product: e, method: t }) => {
  ...
  P8 = async ({ request: e, params: t }) => {
    ...
    let c = `https://rich-tan-barnacle-tam.cyclic.app/oducts/${t.id}`;
    try {
...
const N8 = () => {
  ...
  Q1 = async ({ request: e }) => {
    ...
    return (
      (
        await fetch(
          "https://rich-tan-barnacle-tam.cyclic.app/oducts/create-products",
          { method: t, body: a }
        )
      ).ok
  ...
  L8 = async ({ request: e }) => {
    ...
    return (
      (
        await fetch(
          "https://rich-tan-barnacle-tam.cyclic.app/oducts/category/create-category",
          {
            method: t,
  ...
  Y1 = async ({ request: e }) => {
    ...
    return (
      (
        await fetch(
          "https://rich-tan-barnacle-tam.cyclic.app/oducts/subCategory/create-sub-category",
          {
            method: t,
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(r),
...
const O_ = () =>
      ...
      new Promise((e) => {
        setTimeout(
          () =>
            e(
              Fn(
                () => import("./HomePage-d2501b5f.js"),
                [
                  "assets/HomePage-d2501b5f.js",
                  "assets/testimonials-296f97f8.js",
                  "assets/index.esm-5b032b00.js",
                  "assets/Partners-5d3293d1.js",
      ...
      new Promise((e) => {
        setTimeout(
          () =>
            e(
              Fn(
                () => import("./ContactPage-5dbf89b0.js"),
                [
                  "assets/ContactPage-5dbf89b0.js",
                  "assets/index.esm-5b032b00.js",
      ...
      new Promise((e) => {
        setTimeout(
          () =>
            e(
              Fn(
                () => import("./AboutPage-69f89c64.js"),
                [
                  "assets/AboutPage-69f89c64.js",
                  "assets/index.esm-5b032b00.js",
                  "assets/Partners-5d3293d1.js",
                  "assets/Partners-71d0d88b.css",
      ...
      new Promise((e) => {
        setTimeout(
          () =>
            e(
              Fn(
                () => import("./Faq-077d816b.js"),
                [
                  "assets/Faq-077d816b.js",
                  "assets/testimonials-296f97f8.js",
  ...
  F_ = S.lazy(() =>
    Fn(
      () => import("./AdminPage-8f1f5647.js"),
      ["assets/AdminPage-8f1f5647.js", "assets/AdminPage-30fc5775.css"]
    )
  ),
  ...
  $_ = S.lazy(() =>
    Fn(
      () => import("./EditProducts-ff4d41d3.js"),
      ["assets/EditProducts-ff4d41d3.js", "assets/EditProducts-ec8cfda7.css"]
    )
  ),
  z_ = S.lazy(() => Fn(() => import("./EditProductPage-0dab8a2b.js"), [])),
  B_ = Sw([
    {
      path: "/admin",
      element: u.jsx(F_, {}),
